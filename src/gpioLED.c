...
int getValue(int nGpio, int modulo){
    int *end = (int*)(GPIO_INSTANCE_ADDRESS(modulo) + GPIO_DATAIN);
    int value = *end;
...
void whitePinHigh(int nGpio, int modulo){
    GPIOPinWrite(GPIO_INSTANCE_ADDRESS(modulo),
         GPIO_INSTANCE_PIN_NUMBER(nGpio),
         PIN_HIGH);     
}

void whitePinLow(int nGpio, int modulo){
    GPIOPinWrite(GPIO_INSTANCE_ADDRESS(modulo),
         GPIO_INSTANCE_PIN_NUMBER(nGpio),
         PIN_LOW);      
}
